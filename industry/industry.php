...
<body>
    ...
    <div class="container">
		...
		<div class="row industry-section">
            <div class="col-sm-12">
				<h1 class="industry-header">Education</h1>
			</div>
			<div class="col-sm-6">
				<p>The <b>Education</b> industry is leveraging online services
		...
		<div class="row industry-section">
            <div class="col-sm-12">
				<h1 class="industry-header">Entertainment</h1>
				</div>
			<div class="col-sm-6">
		...
		<div class="row industry-section">
            <div class="col-sm-12">
				<h1 class="industry-header">Healthcare</h1>
				</div>
			<div class="col-sm-6">
		...
		<div class="row industry-section">
            <div class="col-sm-12">
				<h1 class="industry-header">Financial Services</h1>
				</div>
			<div class="col-sm-6">
		...
		<div class="row industry-section">
            <div class="col-sm-12">
				<h1 class="industry-header">Government</h1>
				</div>
			<div class="col-sm-6">
